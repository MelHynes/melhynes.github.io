...
.directive('amMultiselect', ['$parse', '$document', '$compile', '$interpolate', '$filter', 'optionParser', '$rootScope',

    function ($parse, $document, $compile, $interpolate, $filter, optionParser, $rootScope) {
    return {
        restrict: 'E',
        require: 'ngModel',
...
//                    	console.log(item);
                    	...
                    	$rootScope.checkChangeMobile(item.model,true);
                    } else {
                    	$rootScope.checkChangeMobile(item.model,false);
                    }
